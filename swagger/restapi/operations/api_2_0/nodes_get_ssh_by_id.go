...
type NodesGetSSHByIDHandlerFunc func(NodesGetSSHByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesGetSSHByIDHandlerFunc) Handle(params NodesGetSSHByIDParams) middleware.Responder {
	return fn(params)
}
...
type NodesGetSSHByIDHandler interface {
	Handle(NodesGetSSHByIDParams) middleware.Responder
}
