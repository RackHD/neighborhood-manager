...
type NodesGetRelationsHandlerFunc func(NodesGetRelationsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesGetRelationsHandlerFunc) Handle(params NodesGetRelationsParams) middleware.Responder {
	return fn(params)
}
...
type NodesGetRelationsHandler interface {
	Handle(NodesGetRelationsParams) middleware.Responder
}
