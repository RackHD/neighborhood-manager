...
type WorkflowsPutGraphsHandlerFunc func(WorkflowsPutGraphsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsPutGraphsHandlerFunc) Handle(params WorkflowsPutGraphsParams) middleware.Responder {
	return fn(params)
}
...
type WorkflowsPutGraphsHandler interface {
	Handle(WorkflowsPutGraphsParams) middleware.Responder
}
