...
// PollersIDGetParams contains all the bound params for the pollers Id get operation
// typically these are obtained from a http.Request
//
// swagger:parameters pollersIdGet
...
func (o *PollersIDGetParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PollersIDGetParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
