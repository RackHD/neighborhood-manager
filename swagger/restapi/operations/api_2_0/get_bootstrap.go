...
type GetBootstrapHandlerFunc func(GetBootstrapParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetBootstrapHandlerFunc) Handle(params GetBootstrapParams) middleware.Responder {
	return fn(params)
}

// GetBootstrapHandler interface for that can handle valid get bootstrap params
type GetBootstrapHandler interface {
	Handle(GetBootstrapParams) middleware.Responder
}
