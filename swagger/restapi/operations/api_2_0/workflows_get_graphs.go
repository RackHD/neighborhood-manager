...
type WorkflowsGetGraphsHandlerFunc func(WorkflowsGetGraphsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsGetGraphsHandlerFunc) Handle(params WorkflowsGetGraphsParams) middleware.Responder {
	return fn(params)
}
...
type WorkflowsGetGraphsHandler interface {
	Handle(WorkflowsGetGraphsParams) middleware.Responder
}
