...
// PollersDeleteParams contains all the bound params for the pollers delete operation
// typically these are obtained from a http.Request
//
// swagger:parameters pollersDelete
...
func (o *PollersDeleteParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *PollersDeleteParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
