...
type NodesPutObmsByNodeIDHandlerFunc func(NodesPutObmsByNodeIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesPutObmsByNodeIDHandlerFunc) Handle(params NodesPutObmsByNodeIDParams) middleware.Responder {
	return fn(params)
}
...
type NodesPutObmsByNodeIDHandler interface {
	Handle(NodesPutObmsByNodeIDParams) middleware.Responder
}
