...
type WorkflowsGetGraphsByNameHandlerFunc func(WorkflowsGetGraphsByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsGetGraphsByNameHandlerFunc) Handle(params WorkflowsGetGraphsByNameParams) middleware.Responder {
	return fn(params)
}
...
type WorkflowsGetGraphsByNameHandler interface {
	Handle(WorkflowsGetGraphsByNameParams) middleware.Responder
}
