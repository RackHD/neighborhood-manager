...
// NodesPatchTagByIDParams contains all the bound params for the nodes patch tag by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters nodesPatchTagById
...
func (o *NodesPatchTagByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r

	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostTags
...
func (o *NodesPatchTagByIDParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
