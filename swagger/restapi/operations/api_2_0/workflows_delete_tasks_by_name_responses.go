...
/*WorkflowsDeleteTasksByNameNoContent Successfully deleted the specified task
...
/*WorkflowsDeleteTasksByNameNotFound The task with the specified injectable name was not found
