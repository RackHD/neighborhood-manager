...
// SkusIDPutPackParams contains all the bound params for the skus Id put pack operation
// typically these are obtained from a http.Request
//
// swagger:parameters skusIdPutPack
...
func (o *SkusIDPutPackParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *SkusIDPutPackParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
