...
type SkusIDGetNodesHandlerFunc func(SkusIDGetNodesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusIDGetNodesHandlerFunc) Handle(params SkusIDGetNodesParams) middleware.Responder {
	return fn(params)
}

// SkusIDGetNodesHandler interface for that can handle valid skus Id get nodes params
type SkusIDGetNodesHandler interface {
	Handle(SkusIDGetNodesParams) middleware.Responder
}
