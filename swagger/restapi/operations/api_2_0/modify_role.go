...
type ModifyRoleHandlerFunc func(ModifyRoleParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ModifyRoleHandlerFunc) Handle(params ModifyRoleParams) middleware.Responder {
	return fn(params)
}

// ModifyRoleHandler interface for that can handle valid modify role params
type ModifyRoleHandler interface {
	Handle(ModifyRoleParams) middleware.Responder
}
