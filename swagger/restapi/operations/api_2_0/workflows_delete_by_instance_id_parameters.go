...
// WorkflowsDeleteByInstanceIDParams contains all the bound params for the workflows delete by instance Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters workflowsDeleteByInstanceId
...
func (o *WorkflowsDeleteByInstanceIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *WorkflowsDeleteByInstanceIDParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
