...
type PollersLibByIDGetHandlerFunc func(PollersLibByIDGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersLibByIDGetHandlerFunc) Handle(params PollersLibByIDGetParams) middleware.Responder {
	return fn(params)
}
...
type PollersLibByIDGetHandler interface {
	Handle(PollersLibByIDGetParams) middleware.Responder
}
