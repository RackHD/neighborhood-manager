...
type LookupsPostHandlerFunc func(LookupsPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn LookupsPostHandlerFunc) Handle(params LookupsPostParams) middleware.Responder {
	return fn(params)
}

// LookupsPostHandler interface for that can handle valid lookups post params
type LookupsPostHandler interface {
	Handle(LookupsPostParams) middleware.Responder
}
