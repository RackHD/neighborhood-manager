...
type TemplatesLibPutHandlerFunc func(TemplatesLibPutParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TemplatesLibPutHandlerFunc) Handle(params TemplatesLibPutParams) middleware.Responder {
	return fn(params)
}

// TemplatesLibPutHandler interface for that can handle valid templates lib put params
type TemplatesLibPutHandler interface {
	Handle(TemplatesLibPutParams) middleware.Responder
}
