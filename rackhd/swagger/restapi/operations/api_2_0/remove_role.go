...
type RemoveRoleHandlerFunc func(RemoveRoleParams) middleware.Responder

// Handle executing the request and returning a response
func (fn RemoveRoleHandlerFunc) Handle(params RemoveRoleParams) middleware.Responder {
	return fn(params)
}

// RemoveRoleHandler interface for that can handle valid remove role params
type RemoveRoleHandler interface {
	Handle(RemoveRoleParams) middleware.Responder
}
