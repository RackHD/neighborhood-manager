...
type ObmsGetByIDHandlerFunc func(ObmsGetByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ObmsGetByIDHandlerFunc) Handle(params ObmsGetByIDParams) middleware.Responder {
	return fn(params)
}

// ObmsGetByIDHandler interface for that can handle valid obms get by Id params
type ObmsGetByIDHandler interface {
	Handle(ObmsGetByIDParams) middleware.Responder
}
