...
type SkusIDPutPackHandlerFunc func(SkusIDPutPackParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusIDPutPackHandlerFunc) Handle(params SkusIDPutPackParams) middleware.Responder {
	return fn(params)
}

// SkusIDPutPackHandler interface for that can handle valid skus Id put pack params
type SkusIDPutPackHandler interface {
	Handle(SkusIDPutPackParams) middleware.Responder
}
