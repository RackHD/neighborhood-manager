...
type PollersLibGetHandlerFunc func(PollersLibGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersLibGetHandlerFunc) Handle(params PollersLibGetParams) middleware.Responder {
	return fn(params)
}

// PollersLibGetHandler interface for that can handle valid pollers lib get params
type PollersLibGetHandler interface {
	Handle(PollersLibGetParams) middleware.Responder
}
