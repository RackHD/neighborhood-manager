...
type SkusPostHandlerFunc func(SkusPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusPostHandlerFunc) Handle(params SkusPostParams) middleware.Responder {
	return fn(params)
}

// SkusPostHandler interface for that can handle valid skus post params
type SkusPostHandler interface {
	Handle(SkusPostParams) middleware.Responder
}
