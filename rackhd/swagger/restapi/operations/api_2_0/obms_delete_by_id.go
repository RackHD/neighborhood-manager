...
type ObmsDeleteByIDHandlerFunc func(ObmsDeleteByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ObmsDeleteByIDHandlerFunc) Handle(params ObmsDeleteByIDParams) middleware.Responder {
	return fn(params)
}

// ObmsDeleteByIDHandler interface for that can handle valid obms delete by Id params
type ObmsDeleteByIDHandler interface {
	Handle(ObmsDeleteByIDParams) middleware.Responder
}
