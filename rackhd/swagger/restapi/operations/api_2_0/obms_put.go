...
type ObmsPutHandlerFunc func(ObmsPutParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ObmsPutHandlerFunc) Handle(params ObmsPutParams) middleware.Responder {
	return fn(params)
}

// ObmsPutHandler interface for that can handle valid obms put params
type ObmsPutHandler interface {
	Handle(ObmsPutParams) middleware.Responder
}
