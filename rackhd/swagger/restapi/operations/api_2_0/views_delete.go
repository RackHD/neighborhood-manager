...
type ViewsDeleteHandlerFunc func(ViewsDeleteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ViewsDeleteHandlerFunc) Handle(params ViewsDeleteParams) middleware.Responder {
	return fn(params)
}

// ViewsDeleteHandler interface for that can handle valid views delete params
type ViewsDeleteHandler interface {
	Handle(ViewsDeleteParams) middleware.Responder
}
