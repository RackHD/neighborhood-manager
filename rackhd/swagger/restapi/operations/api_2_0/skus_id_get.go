...
type SkusIDGetHandlerFunc func(SkusIDGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusIDGetHandlerFunc) Handle(params SkusIDGetParams) middleware.Responder {
	return fn(params)
}

// SkusIDGetHandler interface for that can handle valid skus Id get params
type SkusIDGetHandler interface {
	Handle(SkusIDGetParams) middleware.Responder
}
