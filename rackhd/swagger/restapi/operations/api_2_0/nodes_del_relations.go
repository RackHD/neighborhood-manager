...
type NodesDelRelationsHandlerFunc func(NodesDelRelationsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesDelRelationsHandlerFunc) Handle(params NodesDelRelationsParams) middleware.Responder {
	return fn(params)
}
...
type NodesDelRelationsHandler interface {
	Handle(NodesDelRelationsParams) middleware.Responder
}
