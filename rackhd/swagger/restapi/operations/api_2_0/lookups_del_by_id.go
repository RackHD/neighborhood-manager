...
type LookupsDelByIDHandlerFunc func(LookupsDelByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn LookupsDelByIDHandlerFunc) Handle(params LookupsDelByIDParams) middleware.Responder {
	return fn(params)
}

// LookupsDelByIDHandler interface for that can handle valid lookups del by Id params
type LookupsDelByIDHandler interface {
	Handle(LookupsDelByIDParams) middleware.Responder
}
