...
// PostTaskByIDParams contains all the bound params for the post task by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters postTaskById
...
func (o *PostTaskByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r

	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.PostTasks
...
func (o *PostTaskByIDParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
