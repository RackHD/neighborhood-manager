...
type NodesGetByIDHandlerFunc func(NodesGetByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesGetByIDHandlerFunc) Handle(params NodesGetByIDParams) middleware.Responder {
	return fn(params)
}

// NodesGetByIDHandler interface for that can handle valid nodes get by Id params
type NodesGetByIDHandler interface {
	Handle(NodesGetByIDParams) middleware.Responder
}
