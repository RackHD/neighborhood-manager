...
// LookupsPostParams contains all the bound params for the lookups post operation
// typically these are obtained from a http.Request
//
// swagger:parameters lookupsPost
...
func (o *LookupsPostParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
