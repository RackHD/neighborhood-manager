...
type TemplatesGetByNameHandlerFunc func(context.Context, TemplatesGetByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TemplatesGetByNameHandlerFunc) Handle(ctx context.Context, params TemplatesGetByNameParams) middleware.Responder {
...
type TemplatesGetByNameHandler interface {
	Handle(context.Context, TemplatesGetByNameParams) middleware.Responder
}
