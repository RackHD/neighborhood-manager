...
type SchemasGetHandlerFunc func(context.Context, SchemasGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SchemasGetHandlerFunc) Handle(ctx context.Context, params SchemasGetParams) middleware.Responder {
	return fn(ctx, params)
}

// SchemasGetHandler interface for that can handle valid schemas get params
type SchemasGetHandler interface {
	Handle(context.Context, SchemasGetParams) middleware.Responder
}
