...
type WorkflowsPostHandlerFunc func(context.Context, WorkflowsPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsPostHandlerFunc) Handle(ctx context.Context, params WorkflowsPostParams) middleware.Responder {
	return fn(ctx, params)
}

// WorkflowsPostHandler interface for that can handle valid workflows post params
type WorkflowsPostHandler interface {
	Handle(context.Context, WorkflowsPostParams) middleware.Responder
}
