...
type SkusGetHandlerFunc func(context.Context, SkusGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusGetHandlerFunc) Handle(ctx context.Context, params SkusGetParams) middleware.Responder {
	return fn(ctx, params)
}

// SkusGetHandler interface for that can handle valid skus get params
type SkusGetHandler interface {
	Handle(context.Context, SkusGetParams) middleware.Responder
}
