...
type ObmsPostLedHandlerFunc func(context.Context, ObmsPostLedParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ObmsPostLedHandlerFunc) Handle(ctx context.Context, params ObmsPostLedParams) middleware.Responder {
	return fn(ctx, params)
}

// ObmsPostLedHandler interface for that can handle valid obms post led params
type ObmsPostLedHandler interface {
	Handle(context.Context, ObmsPostLedParams) middleware.Responder
}
