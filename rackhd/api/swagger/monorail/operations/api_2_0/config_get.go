...
type ConfigGetHandlerFunc func(context.Context, ConfigGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ConfigGetHandlerFunc) Handle(ctx context.Context, params ConfigGetParams) middleware.Responder {
	return fn(ctx, params)
}

// ConfigGetHandler interface for that can handle valid config get params
type ConfigGetHandler interface {
	Handle(context.Context, ConfigGetParams) middleware.Responder
}
