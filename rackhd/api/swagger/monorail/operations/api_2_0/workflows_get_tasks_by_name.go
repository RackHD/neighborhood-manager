...
type WorkflowsGetTasksByNameHandlerFunc func(context.Context, WorkflowsGetTasksByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsGetTasksByNameHandlerFunc) Handle(ctx context.Context, params WorkflowsGetTasksByNameParams) middleware.Responder {
...
type WorkflowsGetTasksByNameHandler interface {
	Handle(context.Context, WorkflowsGetTasksByNameParams) middleware.Responder
}
