...
type ProfilesGetLibByNameHandlerFunc func(context.Context, ProfilesGetLibByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ProfilesGetLibByNameHandlerFunc) Handle(ctx context.Context, params ProfilesGetLibByNameParams) middleware.Responder {
...
type ProfilesGetLibByNameHandler interface {
	Handle(context.Context, ProfilesGetLibByNameParams) middleware.Responder
}
