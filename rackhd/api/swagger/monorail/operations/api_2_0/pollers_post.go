...
type PollersPostHandlerFunc func(context.Context, PollersPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersPostHandlerFunc) Handle(ctx context.Context, params PollersPostParams) middleware.Responder {
	return fn(ctx, params)
}

// PollersPostHandler interface for that can handle valid pollers post params
type PollersPostHandler interface {
	Handle(context.Context, PollersPostParams) middleware.Responder
}
