...
type LookupsGetByIDHandlerFunc func(context.Context, LookupsGetByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn LookupsGetByIDHandlerFunc) Handle(ctx context.Context, params LookupsGetByIDParams) middleware.Responder {
...
type LookupsGetByIDHandler interface {
	Handle(context.Context, LookupsGetByIDParams) middleware.Responder
}
