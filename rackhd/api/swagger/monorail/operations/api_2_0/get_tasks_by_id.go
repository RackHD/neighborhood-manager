...
type GetTasksByIDHandlerFunc func(context.Context, GetTasksByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetTasksByIDHandlerFunc) Handle(ctx context.Context, params GetTasksByIDParams) middleware.Responder {
	return fn(ctx, params)
}

// GetTasksByIDHandler interface for that can handle valid get tasks by Id params
type GetTasksByIDHandler interface {
	Handle(context.Context, GetTasksByIDParams) middleware.Responder
}
