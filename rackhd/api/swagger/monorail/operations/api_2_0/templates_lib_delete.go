...
type TemplatesLibDeleteHandlerFunc func(context.Context, TemplatesLibDeleteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TemplatesLibDeleteHandlerFunc) Handle(ctx context.Context, params TemplatesLibDeleteParams) middleware.Responder {
...
type TemplatesLibDeleteHandler interface {
	Handle(context.Context, TemplatesLibDeleteParams) middleware.Responder
}
