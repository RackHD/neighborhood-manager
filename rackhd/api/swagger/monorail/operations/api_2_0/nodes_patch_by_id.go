...
type NodesPatchByIDHandlerFunc func(context.Context, NodesPatchByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesPatchByIDHandlerFunc) Handle(ctx context.Context, params NodesPatchByIDParams) middleware.Responder {
...
type NodesPatchByIDHandler interface {
	Handle(context.Context, NodesPatchByIDParams) middleware.Responder
}
