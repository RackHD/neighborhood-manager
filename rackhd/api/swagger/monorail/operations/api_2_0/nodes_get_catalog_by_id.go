...
type NodesGetCatalogByIDHandlerFunc func(context.Context, NodesGetCatalogByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesGetCatalogByIDHandlerFunc) Handle(ctx context.Context, params NodesGetCatalogByIDParams) middleware.Responder {
...
type NodesGetCatalogByIDHandler interface {
	Handle(context.Context, NodesGetCatalogByIDParams) middleware.Responder
}
