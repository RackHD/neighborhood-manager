...
type NodesPostSSHByIDHandlerFunc func(context.Context, NodesPostSSHByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesPostSSHByIDHandlerFunc) Handle(ctx context.Context, params NodesPostSSHByIDParams) middleware.Responder {
...
type NodesPostSSHByIDHandler interface {
	Handle(context.Context, NodesPostSSHByIDParams) middleware.Responder
}
