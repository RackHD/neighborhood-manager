...
type PollersPatchHandlerFunc func(context.Context, PollersPatchParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersPatchHandlerFunc) Handle(ctx context.Context, params PollersPatchParams) middleware.Responder {
	return fn(ctx, params)
}

// PollersPatchHandler interface for that can handle valid pollers patch params
type PollersPatchHandler interface {
	Handle(context.Context, PollersPatchParams) middleware.Responder
}
