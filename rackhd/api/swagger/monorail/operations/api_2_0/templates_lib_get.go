...
type TemplatesLibGetHandlerFunc func(context.Context, TemplatesLibGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TemplatesLibGetHandlerFunc) Handle(ctx context.Context, params TemplatesLibGetParams) middleware.Responder {
...
type TemplatesLibGetHandler interface {
	Handle(context.Context, TemplatesLibGetParams) middleware.Responder
}
