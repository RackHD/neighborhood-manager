...
type NodesGetAllHandlerFunc func(context.Context, NodesGetAllParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesGetAllHandlerFunc) Handle(ctx context.Context, params NodesGetAllParams) middleware.Responder {
	return fn(ctx, params)
}

// NodesGetAllHandler interface for that can handle valid nodes get all params
type NodesGetAllHandler interface {
	Handle(context.Context, NodesGetAllParams) middleware.Responder
}
