...
type LookupsGetHandlerFunc func(context.Context, LookupsGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn LookupsGetHandlerFunc) Handle(ctx context.Context, params LookupsGetParams) middleware.Responder {
	return fn(ctx, params)
}

// LookupsGetHandler interface for that can handle valid lookups get params
type LookupsGetHandler interface {
	Handle(context.Context, LookupsGetParams) middleware.Responder
}
