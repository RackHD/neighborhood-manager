...
type FilesMd5GetHandlerFunc func(context.Context, FilesMd5GetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn FilesMd5GetHandlerFunc) Handle(ctx context.Context, params FilesMd5GetParams) middleware.Responder {
	return fn(ctx, params)
}

// FilesMd5GetHandler interface for that can handle valid files md5 get params
type FilesMd5GetHandler interface {
	Handle(context.Context, FilesMd5GetParams) middleware.Responder
}
