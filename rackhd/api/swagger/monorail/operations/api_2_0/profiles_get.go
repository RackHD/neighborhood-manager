...
type ProfilesGetHandlerFunc func(context.Context, ProfilesGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ProfilesGetHandlerFunc) Handle(ctx context.Context, params ProfilesGetParams) middleware.Responder {
	return fn(ctx, params)
}

// ProfilesGetHandler interface for that can handle valid profiles get params
type ProfilesGetHandler interface {
	Handle(context.Context, ProfilesGetParams) middleware.Responder
}
