...
type GetNodesByTagHandlerFunc func(context.Context, GetNodesByTagParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetNodesByTagHandlerFunc) Handle(ctx context.Context, params GetNodesByTagParams) middleware.Responder {
	return fn(ctx, params)
}

// GetNodesByTagHandler interface for that can handle valid get nodes by tag params
type GetNodesByTagHandler interface {
	Handle(context.Context, GetNodesByTagParams) middleware.Responder
}
