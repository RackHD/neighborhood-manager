...
type NodesDelTagByIDHandlerFunc func(context.Context, NodesDelTagByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesDelTagByIDHandlerFunc) Handle(ctx context.Context, params NodesDelTagByIDParams) middleware.Responder {
...
type NodesDelTagByIDHandler interface {
	Handle(context.Context, NodesDelTagByIDParams) middleware.Responder
}
