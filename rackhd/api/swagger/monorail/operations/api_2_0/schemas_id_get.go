...
type SchemasIDGetHandlerFunc func(context.Context, SchemasIDGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SchemasIDGetHandlerFunc) Handle(ctx context.Context, params SchemasIDGetParams) middleware.Responder {
	return fn(ctx, params)
}

// SchemasIDGetHandler interface for that can handle valid schemas Id get params
type SchemasIDGetHandler interface {
	Handle(context.Context, SchemasIDGetParams) middleware.Responder
}
