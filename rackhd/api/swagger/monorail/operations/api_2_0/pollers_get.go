...
type PollersGetHandlerFunc func(context.Context, PollersGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersGetHandlerFunc) Handle(ctx context.Context, params PollersGetParams) middleware.Responder {
	return fn(ctx, params)
}

// PollersGetHandler interface for that can handle valid pollers get params
type PollersGetHandler interface {
	Handle(context.Context, PollersGetParams) middleware.Responder
}
