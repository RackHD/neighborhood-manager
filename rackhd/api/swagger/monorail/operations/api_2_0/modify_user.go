...
type ModifyUserHandlerFunc func(context.Context, ModifyUserParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ModifyUserHandlerFunc) Handle(ctx context.Context, params ModifyUserParams) middleware.Responder {
	return fn(ctx, params)
}

// ModifyUserHandler interface for that can handle valid modify user params
type ModifyUserHandler interface {
	Handle(context.Context, ModifyUserParams) middleware.Responder
}
