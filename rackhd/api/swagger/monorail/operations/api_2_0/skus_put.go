...
type SkusPutHandlerFunc func(context.Context, SkusPutParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusPutHandlerFunc) Handle(ctx context.Context, params SkusPutParams) middleware.Responder {
	return fn(ctx, params)
}

// SkusPutHandler interface for that can handle valid skus put params
type SkusPutHandler interface {
	Handle(context.Context, SkusPutParams) middleware.Responder
}
