...
type PostWorkflowByIDHandlerFunc func(context.Context, PostWorkflowByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PostWorkflowByIDHandlerFunc) Handle(ctx context.Context, params PostWorkflowByIDParams) middleware.Responder {
...
type PostWorkflowByIDHandler interface {
	Handle(context.Context, PostWorkflowByIDParams) middleware.Responder
}
