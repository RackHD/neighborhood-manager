...
type NodesWorkflowActionByIDHandlerFunc func(context.Context, NodesWorkflowActionByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesWorkflowActionByIDHandlerFunc) Handle(ctx context.Context, params NodesWorkflowActionByIDParams) middleware.Responder {
...
type NodesWorkflowActionByIDHandler interface {
	Handle(context.Context, NodesWorkflowActionByIDParams) middleware.Responder
}
