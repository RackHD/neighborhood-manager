...
type RemoveUserHandlerFunc func(context.Context, RemoveUserParams) middleware.Responder

// Handle executing the request and returning a response
func (fn RemoveUserHandlerFunc) Handle(ctx context.Context, params RemoveUserParams) middleware.Responder {
	return fn(ctx, params)
}

// RemoveUserHandler interface for that can handle valid remove user params
type RemoveUserHandler interface {
	Handle(context.Context, RemoveUserParams) middleware.Responder
}
