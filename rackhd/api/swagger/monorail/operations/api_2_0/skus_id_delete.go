...
type SkusIDDeleteHandlerFunc func(context.Context, SkusIDDeleteParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkusIDDeleteHandlerFunc) Handle(ctx context.Context, params SkusIDDeleteParams) middleware.Responder {
	return fn(ctx, params)
}

// SkusIDDeleteHandler interface for that can handle valid skus Id delete params
type SkusIDDeleteHandler interface {
	Handle(context.Context, SkusIDDeleteParams) middleware.Responder
}
