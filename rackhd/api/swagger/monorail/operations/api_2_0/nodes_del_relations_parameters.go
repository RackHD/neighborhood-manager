...
// NodesDelRelationsParams contains all the bound params for the nodes del relations operation
// typically these are obtained from a http.Request
//
// swagger:parameters nodesDelRelations
...
func (o *NodesDelRelationsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	o.HTTPRequest = r
...
func (o *NodesDelRelationsParams) bindIdentifier(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
