...
type NodesPostHandlerFunc func(context.Context, NodesPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesPostHandlerFunc) Handle(ctx context.Context, params NodesPostParams) middleware.Responder {
	return fn(ctx, params)
}

// NodesPostHandler interface for that can handle valid nodes post params
type NodesPostHandler interface {
	Handle(context.Context, NodesPostParams) middleware.Responder
}
