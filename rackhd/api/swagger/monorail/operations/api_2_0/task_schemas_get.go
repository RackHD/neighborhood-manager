...
type TaskSchemasGetHandlerFunc func(context.Context, TaskSchemasGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TaskSchemasGetHandlerFunc) Handle(ctx context.Context, params TaskSchemasGetParams) middleware.Responder {
...
type TaskSchemasGetHandler interface {
	Handle(context.Context, TaskSchemasGetParams) middleware.Responder
}
