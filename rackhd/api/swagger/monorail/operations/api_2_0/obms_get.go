...
type ObmsGetHandlerFunc func(context.Context, ObmsGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ObmsGetHandlerFunc) Handle(ctx context.Context, params ObmsGetParams) middleware.Responder {
	return fn(ctx, params)
}

// ObmsGetHandler interface for that can handle valid obms get params
type ObmsGetHandler interface {
	Handle(context.Context, ObmsGetParams) middleware.Responder
}
