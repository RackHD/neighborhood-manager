...
type NodesPostWorkflowByIDHandlerFunc func(context.Context, NodesPostWorkflowByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn NodesPostWorkflowByIDHandlerFunc) Handle(ctx context.Context, params NodesPostWorkflowByIDParams) middleware.Responder {
...
type NodesPostWorkflowByIDHandler interface {
	Handle(context.Context, NodesPostWorkflowByIDParams) middleware.Responder
}
