...
type WorkflowsDeleteGraphsByNameHandlerFunc func(context.Context, WorkflowsDeleteGraphsByNameParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsDeleteGraphsByNameHandlerFunc) Handle(ctx context.Context, params WorkflowsDeleteGraphsByNameParams) middleware.Responder {
...
type WorkflowsDeleteGraphsByNameHandler interface {
	Handle(context.Context, WorkflowsDeleteGraphsByNameParams) middleware.Responder
}
