...
type GetAllTagsHandlerFunc func(context.Context, GetAllTagsParams) middleware.Responder

// Handle executing the request and returning a response
func (fn GetAllTagsHandlerFunc) Handle(ctx context.Context, params GetAllTagsParams) middleware.Responder {
	return fn(ctx, params)
}

// GetAllTagsHandler interface for that can handle valid get all tags params
type GetAllTagsHandler interface {
	Handle(context.Context, GetAllTagsParams) middleware.Responder
}
