...
type WorkflowsGetAllTasksHandlerFunc func(context.Context, WorkflowsGetAllTasksParams) middleware.Responder

// Handle executing the request and returning a response
func (fn WorkflowsGetAllTasksHandlerFunc) Handle(ctx context.Context, params WorkflowsGetAllTasksParams) middleware.Responder {
...
type WorkflowsGetAllTasksHandler interface {
	Handle(context.Context, WorkflowsGetAllTasksParams) middleware.Responder
}
