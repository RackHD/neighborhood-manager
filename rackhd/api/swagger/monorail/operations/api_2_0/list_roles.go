...
type ListRolesHandlerFunc func(context.Context, ListRolesParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ListRolesHandlerFunc) Handle(ctx context.Context, params ListRolesParams) middleware.Responder {
	return fn(ctx, params)
}

// ListRolesHandler interface for that can handle valid list roles params
type ListRolesHandler interface {
	Handle(context.Context, ListRolesParams) middleware.Responder
}
