...
type TemplatesMetaGetHandlerFunc func(context.Context, TemplatesMetaGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn TemplatesMetaGetHandlerFunc) Handle(ctx context.Context, params TemplatesMetaGetParams) middleware.Responder {
...
type TemplatesMetaGetHandler interface {
	Handle(context.Context, TemplatesMetaGetParams) middleware.Responder
}
