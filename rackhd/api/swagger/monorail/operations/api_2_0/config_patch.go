...
type ConfigPatchHandlerFunc func(context.Context, ConfigPatchParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ConfigPatchHandlerFunc) Handle(ctx context.Context, params ConfigPatchParams) middleware.Responder {
	return fn(ctx, params)
}

// ConfigPatchHandler interface for that can handle valid config patch params
type ConfigPatchHandler interface {
	Handle(context.Context, ConfigPatchParams) middleware.Responder
}
