...
type PollersDataGetHandlerFunc func(context.Context, PollersDataGetParams) middleware.Responder

// Handle executing the request and returning a response
func (fn PollersDataGetHandlerFunc) Handle(ctx context.Context, params PollersDataGetParams) middleware.Responder {
...
type PollersDataGetHandler interface {
	Handle(context.Context, PollersDataGetParams) middleware.Responder
}
