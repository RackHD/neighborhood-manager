...
type LookupsPatchByIDHandlerFunc func(context.Context, LookupsPatchByIDParams) middleware.Responder

// Handle executing the request and returning a response
func (fn LookupsPatchByIDHandlerFunc) Handle(ctx context.Context, params LookupsPatchByIDParams) middleware.Responder {
...
type LookupsPatchByIDHandler interface {
	Handle(context.Context, LookupsPatchByIDParams) middleware.Responder
}
