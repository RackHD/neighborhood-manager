...
type SkuPackPostHandlerFunc func(context.Context, SkuPackPostParams) middleware.Responder

// Handle executing the request and returning a response
func (fn SkuPackPostHandlerFunc) Handle(ctx context.Context, params SkuPackPostParams) middleware.Responder {
	return fn(ctx, params)
}

// SkuPackPostHandler interface for that can handle valid sku pack post params
type SkuPackPostHandler interface {
	Handle(context.Context, SkuPackPostParams) middleware.Responder
}
